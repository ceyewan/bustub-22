...
private:
  ...
  Page *FindLeafPageRW(const KeyType &key, Transaction *transaction,
                       Operation op);

  void UnlockAndUnpin(Transaction *pTransaction, Operation operation);

  bool IsSafe(Page *pPage, Operation operation);

  void InsertInParent(Page *page_leaf, const KeyType &key, Page *page_bother);

  void DeleteEntry(Page *&page, const KeyType &key);

  int GetMaxsize(BPlusTreePage *page) const;

  void DeleteEntryRW(Page *&page, const KeyType &key, Transaction *transaction);

  void InsertInParentRW(Page *page_leaf, const KeyType &key, Page *page_bother,
